...
module.exports = {
  lintOnSave: !isProd,
  outputDir: '../ecshop_yg/h5',
  assetsDir: 'static',
  publicPath: isProd ? process.env.VUE_APP_STATIC_PATH + '/h5' : '/',
  ...
  devServer: {
    ...
    proxy: {
      '/hd/itzPriceComplaint/front/list': {
        // 我的价格投诉列表
        target: 'http://192.168.2.153:8991',
        changeOrigin: true,
        secure: false
      },
      '/hd/itzPriceComplaint/front/status': {
        // 获取商品的价格投诉状态
        target: 'http://192.168.2.244:8991',
        changeOrigin: true,
        secure: false
      },
      '/hd/itzPriceComplaint/front/detail': {
        // 获取商品的价格投诉详情
        target: 'http://192.168.2.153:8991',
        changeOrigin: true,
        secure: false
