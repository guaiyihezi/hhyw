window.iTouziAPP = (function() {
  ...
  var imps = {
    ...
    openImagePage: function(imageUrls, selectIndex) {
      if (window.javaObj) {
        return window.javaObj.openImagePage(imageUrls)
      }
    ...
    getUserHashId: function() {
      if (window.javaObj) {
        return window.javaObj.getUserHashId()
      }
    ...
    handleNavigationActionHidden: function(back_hidden, close_hidden) {
      if (window.javaObj) {
        return window.javaObj.handleNavigationActionHidden(back_hidden, close_hidden)
      }
    ...
    openSobot: function() {
      if (window.javaObj) {
        return window.javaObj.openSobot()
      }
      _request('openSobot')
    },
    ...
    register: function() {
      if (window.javaObj) {
        return window.javaObj.register()
      }
      _request('register')
    },
    ...
    hasLogged: function() {
      if (window.javaObj) {
        return window.javaObj.hasLogged()
      }
    ...
    getAppVersion: function() {
      if (window.javaObj) {
        return window.javaObj.getAppVersion()
      }
    ...
    openPage: function(url) {
      if (window.javaObj) {
        return window.javaObj.openPage(url)
      }
    ...
    share: function(text, imageUrl, platform, flag, title, url, description) {
      ...
      if (window.javaObj) {
        return window.javaObj.share(text, imageUrl, platform, flag, title, url, description || '')
      }
      _request('share', {
        text: text,
        platform: platform,
    ...
    openInvestment: function(id) {
      if (window.javaObj) {
        return window.javaObj.openInvestment(id)
      }
    ...
    openInvestmentList: function() {
      if (window.javaObj) {
        return window.javaObj.openInvestmentList()
      }
    ...
    openDebtList: function() {
      if (window.javaObj) {
        return window.javaObj.openDebtList()
      }
    ...
    openCouponList: function() {
      if (window.javaObj) {
        return window.javaObj.openCouponList()
      }
    ...
    openMyAccountPage: function() {
      if (window.javaObj) {
        return window.javaObj.openMyAccountPage()
      }
    ...
    openCapitalPage: function() {
      if (window.javaObj) {
        return window.javaObj.openCapitalPage()
      }
    ...
    openRechargePage: function() {
      if (window.javaObj) {
        return window.javaObj.openRechargePage()
      }
    ...
    openWithdrawPage: function() {
      if (window.javaObj) {
        return window.javaObj.openWithdrawPage()
      }
    ...
    openInvestRecordsPage: function() {
      if (window.javaObj) {
        return window.javaObj.openInvestRecordsPage()
      }
    ...
    openTradeList: function() {
      if (window.javaObj) {
        return window.javaObj.openTradeList()
      }
    ...
    openRepaymentPage: function() {
      if (window.javaObj) {
        return window.javaObj.openRepaymentPage()
      }
    ...
    openInvestListByType: function(type) {
      if (window.javaObj) {
        return window.javaObj.openInvestListByType(type)
      }
    ...
    getDeviceIMEI: function() {
      if (window.javaObj) {
        return window.javaObj.getDeviceIMEI()
      }
    },
    /*获取设备AndroidID号，优先使用------Android 专属*/
    getDeviceAndroidID: function() {
      if (window.javaObj) {
        return window.javaObj.getDeviceAndroidID()
      }
    },
    // 以下是1.7.0 版本添加
    /*
    ...
    openSecuritySettingPage: function(data) {
      if (window.javaObj) {
        return window.javaObj.openSecuritySettingPage(data)
      }
    ...
    openInvitePage: function() {
      if (window.javaObj) {
        return window.javaObj.openInvitePage()
      }
    ...
    evaluateSuccess: function() {
      if (window.javaObj) {
        return window.javaObj.evaluateSuccess()
      }
    ...
    openIntegral: function() {
      if (window.javaObj) {
        return window.javaObj.openIntegral()
      }
    ...
    openUserIntegrate: function() {
      if (window.javaObj) {
        return window.javaObj.openUserIntegrate()
      }
    ...
    openSignCenter: function() {
      if (window.javaObj) {
        return window.javaObj.openSignCenter()
      }
    ...
    showUmengShare: function(text, imageUrl, platform, flag, title, url, description) {
      ...
      if (window.javaObj && appVersion) {
        ...
        if (appVersion > 230) {
          return window.javaObj.showUmengShare(text, imageUrl, platform, flag, title, url, description || '')
        } else {
          return false
        }
      }
    ...
    openOtherApp: function(appScheme) {
      if (window.javaObj) {
        return window.javaObj.openOtherApp(appScheme)
      }
    ...
    bankHandleSucceeded: function(type) {
      if (window.javaObj) {
        return window.javaObj.bankHandleSucceeded(type)
      }
    ...
    bankHandleFailed: function(type) {
      if (window.javaObj) {
        return window.javaObj.bankHandleFailed(type)
      }
    ...
    bankHandleAbort: function(type) {
      if (window.javaObj) {
        return window.javaObj.bankHandleAbort(type)
      }
    ...
    copyText: function(text) {
      if (window.javaObj) {
        return window.javaObj.copyText(text)
      }
    ...
    hideBackButton: function() {
      if (window.javaObj) {
        return window.javaObj.hideBackButton()
      }
    ...
    goDiscovery: function() {
      if (window.javaObj) {
        return window.javaObj.goDiscovery()
      }
    ...
    goUserHome: function() {
      if (window.javaObj) {
        return window.javaObj.goUserHome()
      }
      _request('goUserHome')
    },
    ...
    onInvestQueue: function(status) {
      if (window.javaObj) {
        return window.javaObj.onInvestQueue(status)
      }
    ...
    refreshPage: function() {
      if (window.javaObj) {
        return window.javaObj.refreshPage()
      }
    ...
    goInvestList: function() {
      if (window.javaObj) {
        return window.javaObj.goInvestList()
      }
    ...
    onFillInComplete: function(type) {
      if (window.javaObj) {
        return window.javaObj.onFillInComplete(type)
      }
    ...
    openProjectList: function(schema) {
      if (window.javaObj) {
        return window.javaObj.openProjectList(schema)
      }
    ...
    openAppPage: function(schema) {
      if (window.javaObj) {
        return window.javaObj.openAppPage(schema)
      }
      // 应 iOS 要求，将“?”替换为了“&”
    ...
    showPureUmengShare: function(info, platforms, type, thumb, actName, description) {
      ...
      if (window.javaObj) {
        return window.javaObj.showPureUmengShare(info, platforms, type, thumb || '', actName || '', description || '')
      }
...
window.iTouziAPP._ready_ = function(callback) {
  ...
  var si = setInterval(function() {
    timeLong += tick
    if (window.iTouziAPP && window.iTouziAPP.getAppVersion() !== undefined) {
      clearInterval(si)
      callback.call()
    }
    // 5s 超时
