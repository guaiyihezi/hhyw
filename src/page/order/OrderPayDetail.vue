    ...
    <div class="detail-container">
      ...
      <div class="pay-detail">
        ...
        <div class="pay-info">
          ...
          <div class="surplus" v-if="surplus_paid != 0">
            <div class="surplus-title" v-if="orderDetail.share_sn">好友支付权益{{ nickname }}</div>
            <div class="surplus-title" v-else>权益支付</div>
      ...
      <div class="rules-wrappers">
        ...
        <div>
          ...
          <p class="rule-item">
            2.换换商城提醒您，为了保证您的利益，请您在收到货物时务必验货，请拆开包装箱，确认货品完好无损、准确无误后再签收；
          </p>
          <p class="rule-item">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如果发现货物在运输途中有包装破损，或验货后发现商品质量、数量有问题的，您有权拒收。请拍照取证，并在快递单上写明拒收原因，再请快递人员退回；
          </p>
          <p class="rule-item bottom10">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;同时请您与商家进行联系，提供证据、说明原因来完成退货/换货。如果商家不配合，您可致电商城服务热线：{{
              service_tel
            }}
            进行咨询或投诉。
          </p>
          ...
          <p class="rule-item">
            3. 如果您申请退货，订单中的权益支付部分会返回至您的权益余额中，现金支付部分会按原支付方式返回。
          </p>
        </div>
      </div>
    </div>
