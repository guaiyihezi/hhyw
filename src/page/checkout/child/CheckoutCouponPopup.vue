    ...
    <div class="coupon-container">
      ...
      <div class="coupon-body" v-if="activeIndex == 1">
        <template v-if="couponList.able_list.length > 0">
          <div class="body-item body-items" v-for="(item, index) in couponList.able_list" :key="index">
            <div class="item-left">
      ...
      <div class="coupon-body" v-if="activeIndex == 2">
        <div class="body-item" v-if="couponList.unable_list.length > 0">
          <template v-for="(item, index) in couponList.unable_list">
            <coupon-item :item="item" :key="index" class="checkable"></coupon-item>
          </template>
        </div>
