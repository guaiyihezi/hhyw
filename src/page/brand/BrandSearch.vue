  ...
  <div class="container">
    <div class="search-header-wrapper">
      <form v-on:submit.prevent="search($event, keywords)" action="#">
        <div>
          <input type="search" placeholder="搜索更多品质好物" v-model="keywords" />
    ...
    <div class="search-body-wrapper">
      ...
      <div class="list-wrapper" v-if="showSearch">
        <div class="list-result" v-if="brandList.length > 0">
          <template v-for="(item, brandIndex) in brandList">
            <brand-list-item :key="brandIndex" :item="item"></brand-list-item>
          </template>
