        ...
        <div class="info-header">
          ...
          <div class="info-header-right">
            ...
            <div class="header-price info-price">
              ...
              <PriceItem
                :cash="utils.formatFloat(Number(shoppingPrice.current_price))"
                :surplus="utils.formatFloat(Number(shoppingPrice.money_line))"
        ...
        <div class="goods-detail-properties">
          ...
          >
            ...
            <div class="istlmt-w-body">
              ...
              <div
                class="istlmt-w-item"
                v-for="(item, istIndex) in detailInfo.instalment"
                :key="`istlmtItem${istIndex}`"
              ...
              >
                ...
                <div class="istlmt-w-price">
                  ...
                  <p class="desc">
                    ...
                    <span>权益积分：{{ utils.formatMoney(item.surplus, true) }}{{ txtPaymentType(item) }}</span>
                  </p>
                </div>
              </div>
            </div>
