<template>
  <div class="container">
    <mt-header class="header" fixed title="权益的兑换规则"> </mt-header>
  ...
  data() {
    return {
      ...
      rules: [
        [
          [
            '可兑换权益的债权项目类型，有「省心计划」、「智选系列」两类',
            '可兑换权益的债权项目状态，有「展期中」、「处置中」、「还款中」三种',
            '债权的转让状态为「转让中」、「已转让」状态时，该笔债权不支持兑换权益',
            '单笔债权余额不足100元的，或者单笔债权兑换权益后剩余余额不足100元的，在兑换权益时需一次性兑换该笔债权的全部金额'
          ]
        ] /*,
        [
          '认购规则',
          [
            '兑换权益申请提交后，已选择的债权将自动发起债权转让，债权受让人将以0.01元进行认购',
            '认购成功后，换换立即发送相应权益至用户账户',
