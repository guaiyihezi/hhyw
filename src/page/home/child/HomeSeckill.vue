<template>
  <div class="sec-container" v-if="hasSeckill">
    ...
    <div @click="goSeckillList">
      <swiper :options="swiperOption" ref="mySwiper" class="list-body">
        <template v-if="seckillInfo.list && seckillInfo.list.length">
          <swiper-slide v-for="item in seckillInfo.list" :key="item.id" class="seckill-swiper">
            <div class="list-item" v-stat="{ id: `index_seckill_entry_product_${item.id}` }">
              ...
              <PriceItem 
                :cash="utils.formatFloat(item.cash_price, true)" 
                :surplus="utils.formatFloat(Number(item.current_price)-Number(item.cash_price), true)" 
              />
  ...
  .list-body {
    ...
    .list-item {
      ...
      .item-price {
        ...
        .icon {
          display: inline-block;
          @include sc(9px, $priceColor, right center);
          font-weight: bold;
          line-height: 10px;
        }
        .num {
      ...
      .item-price-line {
        ...
        .icon {
          display: inline-block;
          @include sc(9px, $normalPriceColor, right center);
          font-weight: bold;
          line-height: 13px;
        ...
        .num {
          display: inline-block;
          @include sc(10px, $normalPriceColor, left center);
          font-weight: 400;
          line-height: 13px;
          text-decoration: line-through;
        }
