<template>
  <div class="home-header">
    ...
    <div class="msg" @click="goMsg">
      <div class="red" v-if="isOnline && unRead"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      unRead: state => state.auth.hasUnReadMsg
    }),
    getInputStyle() {
      const style = {}
      if (this.headerBackgroundOpacite <= 0.214) {
        style.backgroundColor = 'rgba(255, 255, 255, 0.214)'
      } else {
