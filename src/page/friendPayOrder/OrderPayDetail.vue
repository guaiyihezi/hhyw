  ...
  <div class="container">
    ...
    <div class="detail-container">
      ...
      <div class="pay-detail">
        ...
        <div class="pay-info">
          ...
          <div class="surplus" v-if="surplus_paid != 0">
            <div class="surplus-title">权益支付</div>
      ...
      <div class="rules-wrappers">
        ...
        <div>
          <p class="rule-item bottom10">1.订单代付完成后，您可以通过【我的】—【换换客】查询订单的相关信息。</p>
          <p class="rule-item">
            2.换换商城提醒各位买家，为了保证各位买家的利益，请买家（收货人）在收到货物时务必验货，请拆开包装箱，确认货品完好无损、准确无误后再签收；
          </p>
          <p class="rule-item">
          ...
          <p class="rule-item">
            3.如果买家申请退货，订单中的代付权益部分会返回至您的权益余额中，现金支付部分会按买家的原支付方式返回。
          </p>
        </div>
      </div>
    </div>
