      ...
      <div class="msg">
        ...
        <div class="price">
          ...
          <label class="huan" v-if="Number(item.money_line)">
            <span class="num">权益抵扣￥{{ utils.formatMoney(item.money_line) }}</span>
          </label> -->
          <PriceItem 
            :cash="utils.formatMoney(item.cash_price)" 
            :surplus=" utils.formatMoney(item.money_line)" 
      ...
      .sell {
        ...
        .speed-wrapper {
          ...
          span {
            margin-top: 3px;
            display: inline-block;
            @include sc(10px, $seckillColor, left);
            font-weight: 300;
            line-height: 14px;
          }
        }
        .waiting {
          @include sc(10px, $seckillColor);
          font-weight: 300;
          line-height: 14px;
        }
        button {
