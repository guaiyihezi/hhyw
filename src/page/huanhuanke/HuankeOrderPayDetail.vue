  ...
  <div class="container">
    ...
    <div class="detail-container">
      ...
      <div class="rules-wrappers">
        ...
        <div>
          <p class="rule-item">1.订单代付完成后，您可以通过【我的】-【浣浣客】查询订单、佣金、变现金额等相关信息。</p>
          <p class="rule-item">
            2.换换商城提醒各位换换客和买家，为了保证各位买家的利益，请买家(收货人)在收到货物时务必验货，请拆开包装箱，确认货品完好无损、准确无误后再签收；
          </p>
          <p class="rule-item">
          ...
          <p class="rule-item">
            3.如果买家申请(部分)退货/款，订单中买家支付的现金会(按比例)以买家原支付方式返回，换换客账户中冻结的佣金、权益变现金额也将会(按比例)扣除，换换客代付的权益部分会(按比例)返回至权益余额中。
          </p>
        </div>
      </div>
    </div>
