    ...
    <template v-if="currentIndex == 1">
      <mt-header class="header" title="账户余额">
        ...
        <header-item
          ...
          titleColor="#552E20"
          title="账单"
          v-on:onclick="goBalanceHistory"
          v-stat="{ id: 'profile_bill' }"
        ></header-item>
      </mt-header>
      <div class="content">
        ...
        <div class="botton-wrapper">
          <gk-button
            ...
            v-if="getMoney >= 0.1"
            v-on:click="goWithdraw"
            v-stat="{ id: 'profile_withdrawal' }"
            >立即提现</gk-button
          >
          <gk-button class="button disable" type="primary-secondary" v-else>立即提现</gk-button>
        </div>
        <p class="warn" @click="changeCurrent(2)" v-stat="{ id: 'profile_attention' }">注意事项</p>
      </div>
    </template>
