    ...
    <div class="container-wrapper" v-show="currentIndex == 3">
      ...
      <div class="rules-content">
        <div class="mlm-version">
          <span class="name name-rules">换换客</span>
        ...
        <template>
          ...
          <p>
            4、分销返佣规则及解释权归换换商城商城所有，如您对该规则有疑问，或有其他意见建议，请按照以下联系方式与我们联系。
          </p>

          <p>
            电话：{{ service_tel }}<br />
            邮箱：huanhuanke@huanhuanyiwu.com<br />
        ...
        <!-- <template v-else>
          <p>
            1、分享商品后，买家通过您分享的链接（或海报中的二维码）购买此商品，您可以在【我的小店】-【付款笔数】-【全部订单】列表中查询到订单，可进行代付权益并获得变现。
          </p>
        
          <p>
            2、您分享到微信朋友圈或微信群的分销商品链接，可被多个买家同时购买，代付权益后您可获得多笔变现。
          </p>
        
          <p>
            3、在分销订单中代付权益后，对应的变现现金及佣金会即时到账（冻结中），该订单买家【确认收货】7天后，该笔订单的变现现金及佣金将可提现。若该订单在买家【确认收货】7天内发生部分退款，则该订单视作【已取消】，全部佣金、代付的权益、变现的金额将原路退回。
          </p>
        
          <p>
            4、分销订单的代付权益有效期为买家【支付成功】至【确认收货】（7+30）天，超时后该笔订单将无法代付；没代付权益不影响平台佣金到账，平台佣金在买家确认收货7日后自动解冻，即时提现。
          </p>
        
          <p>
            5、分销返佣规则及解释权归换换商城商城所有，如您对该规则有疑问，或有其他意见建议，请按照以下联系方式与我们联系。
          </p>
...
export default {
  ...
  data() {
    return {
      ...
      currentIndex: 1, // 当前展示内容 1--详情; 2--换换客介绍; 3--分销返佣规则; 4--创建分销返佣海报
      user_money: 300, // 账户佣金
      readCheckbox: false,
