...
const initState = {
  ...
  isShowHBRules: false, // 是否展示权益说明
  isShowServeTag: false, // 是否展示服务标签
  productSharer: [], //商品的换换客分享信息
  sharerTotal: 0, // 换换客获取
...
const getters = {
  ...
  hasSelectProperty: function(state) {
    ...
    if (state.detailInfo.id && state.detailInfo.properties && state.detailInfo.properties.length) {
