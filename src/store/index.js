...
import myC2B from './modules/myC2B'
import priceJudge from './modules/priceJudge'
...
export default new Vuex.Store({
  ...
  plugins: [
    createPersistedState({
      key: 'ecm',
      paths: ['auth', 'region', 'tabBar', 'category', 'home', 'mlm', 'keepAlive', 'checkout', 'coupon', 'priceJudge']
    })
  ]
})
