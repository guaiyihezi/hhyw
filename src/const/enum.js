export const ENUM = {
  SERVICE: {
    ...
    MASTER_TEL: '010-53324196、010-53324198'
  },

  // 错误代码
  ERROR_CODE: {
    OK: 0, //  正常
    TOKEN_INVALID: 401, //  Token 无效(或是过期: data有数据就是过期)
    ...
    PAYPWD_ERROR_OUT_OF_LIMIT: 3306, //  权益支付密码输入次数超过限制次数
    PAYPWD_ERROR_INVALID: 100 //  权益支付密码错误
  },
